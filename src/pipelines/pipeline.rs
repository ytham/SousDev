...
// `PipelineResult` is defined in stores.rs; re-export for downstream convenience.
pub use crate::pipelines::stores::PipelineResult;

/// Build a [`PipelineResult`] that represents a skipped (no-op) run.
///
...
mod tests {
    ...
    fn test_make_skipped_result_no_error() {
        ...
        assert_eq!(r.pipeline_name, "my-pipe");
